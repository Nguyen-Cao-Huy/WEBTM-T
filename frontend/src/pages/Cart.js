...
const Cart = () => {
    ...
    const handlePayment = async () => {
        ...
        // Gửi yêu cầu fetch đến API thanh toán
        const response = await fetch(SummaryApi.payment.url, {
          method: SummaryApi.payment.method,
          credentials: 'include', // Bao gồm cookie trong yêu cầu
          headers: {
            'content-type': 'application/json' // Đặt header để chỉ định dữ liệu gửi đi là JSON
          },
          body: JSON.stringify({
            cartItems : data
          }) // Chuyển đổi dữ liệu thành JSON và gửi đi
        });
